...
Escribe un programa que verifique si un número es par o impar utilizando  if . ![](Aspose.Words.59e8973c-d56a-4603-a1d0-c0515f608595.001.png)**Enunciado:**
...
if .![](Aspose.Words.59e8973c-d56a-4603-a1d0-c0515f608595.002.png)
...
Utiliza  match para implementar una calculadora simple.![](Aspose.Words.59e8973c-d56a-4603-a1d0-c0515f608595.003.png)

**Enunciado:**

Crea una calculadora que solicite dos números y una operación matemática (+, -, \*, /). Usa  match ![](Aspose.Words.59e8973c-d56a-4603-a1d0-c0515f608595.004.png)para realizar la operación correspondiente.

**Ejercicio 4: Determinación del tipo de triángulo**

Escribe un programa que determine el tipo de triángulo en función de sus lados usando  if .![](Aspose.Words.59e8973c-d56a-4603-a1d0-c0515f608595.005.png)
...
Escribe un programa que, dado un número del 1 al 7, imprima el día correspondiente de la semana usando  match .![](Aspose.Words.59e8973c-d56a-4603-a1d0-c0515f608595.006.png)
...
Escribe un programa que determine si un número es positivo, negativo o cero usando  if . ![](Aspose.Words.59e8973c-d56a-4603-a1d0-c0515f608595.007.png)**Enunciado:**
...
match .![](Aspose.Words.59e8973c-d56a-4603-a1d0-c0515f608595.008.png)

**Enunciado:**

Solicita al usuario que ingrese una temperatura y una escala (C o F). Convierte la temperatura a la escala opuesta usando  match .![](Aspose.Words.59e8973c-d56a-4603-a1d0-c0515f608595.009.png)
...
Escribe un programa que determine el mayor de tres números usando  if . ![](Aspose.Words.59e8973c-d56a-4603-a1d0-c0515f608595.010.png)**Enunciado:**

Solicita al usuario que ingrese tres números y determina cuál es el mayor.

**Ejercicio 14: Adivinanza de letras**

Escribe un programa que permita al usuario adivinar una letra secreta usando  match .![](Aspose.Words.59e8973c-d56a-4603-a1d0-c0515f608595.011.png)
...
Escribe un programa que convierta una calificación numérica en una letra de acuerdo a un sistema de calificación específico, usando  match .![](Aspose.Words.59e8973c-d56a-4603-a1d0-c0515f608595.012.png)
...
Escribe un programa que clasifique un triángulo en agudo, obtuso o rectángulo según sus ángulos internos usando  if .![](Aspose.Words.59e8973c-d56a-4603-a1d0-c0515f608595.013.png)
...
**Estructuras Iterativas![](Aspose.Words.59e8973c-d56a-4603-a1d0-c0515f608595.014.png)**

**Ejercicio 1: Suma de los primeros N números enteros**

**Enunciado:**

Escribe un programa que solicite al usuario un número entero positivo  n y calcule la suma de los primeros ![](Aspose.Words.59e8973c-d56a-4603-a1d0-c0515f608595.015.png) n números enteros. Utiliza un ciclo  for para realizar la suma.![](Aspose.Words.59e8973c-d56a-4603-a1d0-c0515f608595.016.png)![](Aspose.Words.59e8973c-d56a-4603-a1d0-c0515f608595.017.png)

**Ejercicio 2: Contador de vocales en una cadena**

**Enunciado:**

Escribe un programa que solicite al usuario una cadena de texto y cuente cuántas vocales (a, e, i, o, u) contiene. Usa un ciclo  for para recorrer la cadena y realizar la cuenta.![](Aspose.Words.59e8973c-d56a-4603-a1d0-c0515f608595.018.png)

**Ejercicio 3: Factorial de un número**

**Enunciado:**

Escribe un programa que solicite al usuario un número entero positivo  n y calcule el factorial de dicho número (![](Aspose.Words.59e8973c-d56a-4603-a1d0-c0515f608595.019.png) n! = 1 \* 2 \* 3 \* ... \* n ). Usa un ciclo  for para realizar el cálculo.![](Aspose.Words.59e8973c-d56a-4603-a1d0-c0515f608595.020.png)![](Aspose.Words.59e8973c-d56a-4603-a1d0-c0515f608595.021.png)

**Ejercicio 4: Números pares en un rango**

**Enunciado:**

Escribe un programa que solicite al usuario dos números enteros, un valor de inicio y un valor de fin. El programa debe imprimir todos los números pares en ese rango, incluyendo los límites. Usa un ciclo  for para recorrer el rango.![](Aspose.Words.59e8973c-d56a-4603-a1d0-c0515f608595.022.png)

**Ejercicio 6: Adivina el número (con**  whi l e **)![](Aspose.Words.59e8973c-d56a-4603-a1d0-c0515f608595.023.png)**

**Enunciado:** **(random.randint(1, 100))**

Escribe un programa que genere un número aleatorio entre 1 y 100 y permita al usuario adivinarlo. El programa debe dar pistas si el número ingresado es mayor o menor que el número secreto. Usa un ciclo  while para permitir al usuario seguir intentando hasta que adivine el número![](Aspose.Words.59e8973c-d56a-4603-a1d0-c0515f608595.024.png)

**Ejercicio 7: Suma de números pares hasta que se introduce un impar**

**Enunciado:**

Escribe un programa que solicite al usuario ingresar números enteros indefinidamente. El programa debe sumar los números siempre que sean pares, pero debe detenerse si el usuario ingresa un número impar. Usa un ciclo  while para lograr esto.![](Aspose.Words.59e8973c-d56a-4603-a1d0-c0515f608595.025.png)
